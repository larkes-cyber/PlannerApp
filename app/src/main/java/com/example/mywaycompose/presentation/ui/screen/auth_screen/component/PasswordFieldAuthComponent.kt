...
fun PasswordFieldAuthComponent(state:MutableState<TextFieldValue>){
    ...
    OutlinedTextField(
        ...
        label = { Text(text = "Введите пароль",  color = FormStrokeColor, fontFamily = monsterrat, fontWeight = FontWeight.Medium, textAlign = TextAlign.Center ) },
        ...
        trailingIcon = {
            ...
            val description = if (passwordVisible.value) "Убрать пароль" else "Показать пароль"
